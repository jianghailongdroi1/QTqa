...
class Pagination(object):
    def __init__(self,totalCount,currentPage,perPageItemNum=10):
        # 数据总个数
        ...
        # print("self.per_page_item_num:",self.per_page_item_num)
    ...
    def start(self):
        if self.current_page == 1:
            # print("self.start:",0)
            return 0
        # print("self.start:",(self.current_page-1) * self.per_page_item_num)
        return (self.current_page-1) * self.per_page_item_num

    def end(self):
        # print("self.end:",self.current_page * self.per_page_item_num )
